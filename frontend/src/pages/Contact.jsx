    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
        ...
        <div  className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='text-gray-500'>500035 SGR Towers <br /> Hyderabad, Telangana, India</p>
          <p className='text-gray-500'>(Tel): (140) 825-372-2291 <br /> Email: admin@kartsy.com</p>
          <p className='font-semibold text-xl text-gray-600'>Careers at Kartsy</p>
